...
class CsvControllerTest {
    ...
    @Test
    void getParameters_shouldSucceed() throws Exception {
    ...
    @Test
    void getDocument_shouldSucceed() throws Exception {
    ...
    @Test
    void uploadRaw_shouldSucceed() throws Exception {
        CsvDocument document = csvService.getDocument(PersonCsvHandler.TYPE);

        this.webClient.perform(post(BASE_URL + "/raw")
